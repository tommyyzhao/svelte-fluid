...
| obstructionColor | RGB \| null | null | Fill color painted over obstruction footprints in the display pass (0–255 RGB, backColor convention). null = backColor silhouette. |
...
| Karman          | Alternating cylinder wake fed by a 6-hue streakline rake; painted cylinder | none (1 cylinder obstruction) |
