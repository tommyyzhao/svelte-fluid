...
/**
 * Create a 1x1 placeholder texture and asynchronously upload the real
 * dithering pattern once the inlined PNG decodes. Returns immediately so
 * the engine can start rendering before the image is ready.
 *
